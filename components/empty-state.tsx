    ...
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
      <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-4 relative"
        ...
        <div className="absolute inset-0 rounded-2xl"
             style={{ background: 'radial-gradient(circle at center, rgba(255,59,92,0.2) 0%, transparent 70%)' }} />
        <CheckCircle2 className="w-6 h-6 text-[#FF3B5C] relative z-10" strokeWidth={1.5} />
      </div>
      ...
      {actionLabel && onAction && (
        <Button onClick={onAction} size="sm"
          className="shadow-[0_0_20px_rgba(255,59,92,0.3)]">
          {actionLabel}
        </Button>
      )}
    </div>
